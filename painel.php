					...
					foreach ($dados as $apt):
						...
						<tr>
							...
							<td>
								...
								<span class="aptImg" style="display: none"><?php echo $apt->getImg() ?></span>
							</td>
							<td>
								<picture class="img-card"
									style="background-image: url(./assets/img/ap/<?php echo $apt->getImg() ?>);">
								</picture>
							</td>
							...
							<td>R$<?php echo number_format($apt->getPrecoCompra(), 2, ",", "."); ?>
							</td>
							<td>
